...
unlink "/Users/ovo/OVO-AUTO/list/SourceList-draft.txt";
unlink "/Users/ovo/OVO-AUTO/list/NameList-draft.txt";
unlink "/Users/ovo/OVO-AUTO/list/allrename-draft.txt";


system("rm /Users/ovo/OVO-AUTO/list/SourceList-draft.txt");
system("rm /Users/ovo/OVO-AUTO/list/NameList-draft.txt");
system("rm /Users/ovo/OVO-AUTO/list/allrename-draft.txt");
my @source_files = glob("/Users/ovo/Dropbox/*IRK.txt");
chomp @source_files;
...
#	print "ra_h=$ra_h,ra_m=$ra_m,ra_s=$ra_s\n";
	...
	open my $fh, ">>", "/Users/ovo/OVO-AUTO/list/SourceList-draft.txt"
	...
	open my $fh1, ">>", "/Users/ovo/OVO-AUTO/list/NameList-draft.txt"
	  or die "Cannot create 'NameList-draft.txt': $!";
	if($object_name =~ /IRAS/){
		print $fh1 "$object_name	$object_name1, \n";
	}else{
		print $fh1 "$object_name1	$object_name2, \n";
	}
	close $fh1;


	# allrename.txt、の中身を観測ファイルから作成する
	open my $fh2, ">>", "/Users/ovo/OVO-AUTO/list/allrename-draft.txt"
	  or die "Cannot create 'allrename-draft.txt': $!";
	if($object_name =~ /IRAS/){
		print $fh2 "$object_name, $object_name, \n";
	}else{
		print $fh2 "$object_name, $object_name2, \n";
	}
	close $fh2;
