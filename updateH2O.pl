...
$Dhtml = "/Users/ovo/OVO-AUTO/HTML";		## Please input a directory of html ##
$Dinp = "/Users/ovo/Dropbox";	## Please input a directory of inputbox ##
$Dpgm = "/Users/ovo/program";	## Please input a directory of program ##
$Ddat = "/Users/ovo/OVO-AUTO/data";		## Please input a directory of data ##

##inputbox内のtxtを読み込む
system("ls $Dinp/*IRK.txt > $Dpgm/newdata.txt");
open(IN,"$Dpgm/newdata.txt");
@file = <IN>;
chomp @file;
close(IN);
...
foreach $files (@file){
	($maepass,$file) = split (/\/Dropbox\//, $files);
